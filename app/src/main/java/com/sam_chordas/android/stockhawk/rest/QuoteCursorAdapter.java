...
public class QuoteCursorAdapter extends CursorRecyclerViewAdapter<QuoteCursorAdapter.ViewHolder>
    ...
    private String isUpDescription;
    ...
    public static RecyclerViewItemClickListener.OnItemClickListener listner;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final Cursor cursor) {
        ...
        if (Utils.showPercent) {
            ...
            viewHolder.change.setContentDescription(mContext.getString(R.string.a11y_percent_change, isUpDescription, PercentChange));
        } else {
            String Change = cursor.getString(cursor.getColumnIndex("change"));
            viewHolder.change.setText(Change);
            viewHolder.change.setContentDescription(mContext.getString(R.string.a11y_change, isUpDescription, Change));
        }
        //  }
